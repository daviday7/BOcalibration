...
local beta_cost_drive1_1 = -6.750000e+00
local beta_cost_share2_1 = -8.800000e+00
local beta_cost_share3_1 = -3.390000e+00
local beta_cost_motor_1 = -5.530000e-01
local beta_cost_taxi_1 = -1.490000e+00
local beta_cost_SMS_1 = -1.690000e+00
local beta_cost_Rail_SMS_1 = -6.750000e+00
local beta_cost_SMS_Pool_1 = -1.490000e+00
local beta_cost_Rail_SMS_Pool_1 = -6.750000e+00

local beta_cost_bus_mrt_2 =  0.000000e+00
local beta_cost_private_bus_2 = -9.990000e+02
local beta_cost_drive1_2 =  0.000000e+00
local beta_cost_share2_2 =  0.000000e+00
local beta_cost_share3_2 =  0.000000e+00
local beta_cost_motor_2 =  0.000000e+00
local beta_cost_taxi_2 =  0.000000e+00
local beta_cost_SMS_2 =  0.000000e+00
local beta_cost_Rail_SMS_2 =  0.000000e+00
local beta_cost_SMS_Pool_2 =  0.000000e+00
local beta_cost_Rail_SMS_Pool_2 =  0.000000e+00

local beta_tt_bus_mrt =  0.000000e+00
local beta_tt_private_bus = -9.990000e+02
local beta_tt_drive1 = -1.040000e+00
local beta_tt_share2 =  0.000000e+00
local beta_tt_share3 =  0.000000e+00
local beta_tt_motor =  0.000000e+00
local beta_tt_walk = -5.000000e+00
local beta_tt_taxi = -1.710000e+00
local beta_tt_SMS = -1.710000e+00
local beta_tt_Rail_SMS = -1.040000e+00
local beta_tt_SMS_Pool = -1.710000e+00
local beta_tt_Rail_SMS_Pool = -1.040000e+00

local beta_log =  7.930000e-01
local beta_area =  5.610000e+00
local beta_population =  0.000000e+00

local beta_central_bus_mrt =  2.840000e-01
local beta_central_private_bus = -9.990000e+02
local beta_central_drive1 =  0.000000e+00
local beta_central_share2 =  2.260000e-01
local beta_central_share3 =  3.670000e-01
local beta_central_motor =  6.180000e-01
local beta_central_walk = -1.320000e+00
local beta_central_taxi =  1.130000e+00
local beta_central_SMS =  1.130000e+00
local beta_central_Rail_SMS =  2.840000e-01
local beta_central_SMS_Pool =  1.130000e+00
local beta_central_Rail_SMS_Pool =  2.840000e-01

local beta_distance_bus_mrt =  0.000000e+00
local beta_distance_private_bus = -9.990000e+02
local beta_distance_drive1 = -1.800000e-02
local beta_distance_share2 = -1.800000e-02
local beta_distance_share3 = -2.990000e-02
local beta_distance_motor = -3.190000e-02
local beta_distance_walk = -1.000000e+00
local beta_distance_taxi =  0.000000e+00
local beta_distance_SMS =  0.000000e+00
local beta_distance_Rail_SMS =  0.000000e+00
local beta_distance_SMS_Pool =  0.000000e+00
local beta_distance_Rail_SMS_Pool =  0.000000e+00

local beta_cons_bus = -5.000000e+00
local beta_cons_mrt = -6.948000e+00
local beta_cons_private_bus = -9.990000e+02
local beta_cons_drive1 = -7.000000e+00
local beta_cons_share2 = -1.051400e+01
local beta_cons_share3 = -1.170500e+01
local beta_cons_motor = -5.218000e+00
local beta_cons_walk = -1.000000e+01
local beta_cons_taxi = -1.053500e+01
local beta_cons_SMS = -1.003500e+01
local beta_cons_Rail_SMS = -1.149300e+01
local beta_cons_SMS_Pool = -1.399300e+01
local beta_cons_Rail_SMS_Pool = -2.261600e+01

local beta_zero_bus =  0.000000e+00
local beta_oneplus_bus = -3.200000e+00
local beta_twoplus_bus = -6.580000e-01
local beta_threeplus_bus =  0.000000e+00

local beta_zero_mrt =  0.000000e+00
local beta_oneplus_mrt = -2.530000e+00
local beta_twoplus_mrt = -1.710000e+00
local beta_threeplus_mrt =  0.000000e+00

local beta_zero_privatebus =  0.000000e+00
local beta_oneplus_privatebus = -3.540000e+00
local beta_twoplus_privatebus =  0.000000e+00
local beta_threeplus_privatebus =  0.000000e+00

local beta_zero_drive1 =  0.000000e+00
local beta_oneplus_drive1 =  0.000000e+00
local beta_twoplus_drive1 =  5.580000e-01
local beta_threeplus_drive1 =  0.000000e+00

local beta_zero_share2 =  0.000000e+00
local beta_oneplus_share2 =  5.020000e-01
local beta_twoplus_share2 =  0.000000e+00
local beta_threeplus_share2 =  0.000000e+00

local beta_zero_share3 =  0.000000e+00
local beta_oneplus_share3 = -5.150000e-01
local beta_twoplus_share3 =  0.000000e+00
local beta_threeplus_share3 =  0.000000e+00

local beta_zero_car_motor =  0.000000e+00
local beta_oneplus_car_motor = -3.120000e+00
local beta_twoplus_car_motor =  0.000000e+00
local beta_threeplus_car_motor =  0.000000e+00

local beta_zero_walk =  0.000000e+00
local beta_oneplus_walk = -2.650000e+00
local beta_twoplus_walk =  0.000000e+00
local beta_threeplus_walk =  0.000000e+00

local beta_zero_taxi =  0.000000e+00
local beta_oneplus_taxi = -3.030000e+00
local beta_twoplus_taxi =  0.000000e+00
local beta_threeplus_taxi =  0.000000e+00

local beta_zero_SMS =  0.000000e+00
local beta_oneplus_SMS = -3.030000e+00
local beta_twoplus_SMS =  0.000000e+00
local beta_threeplus_SMS =  0.000000e+00

local beta_zero_SMS_Pool =  0.000000e+00
local beta_oneplus_SMS_Pool = -3.030000e+00
local beta_twoplus_SMS_Pool =  0.000000e+00
local beta_threeplus_SMS_Pool =  0.000000e+00

local beta_zero_Rail_SMS =  0.000000e+00
local beta_oneplus_Rail_SMS = -2.530000e+00
local beta_twoplus_Rail_SMS = -1.710000e+00
local beta_threeplus_Rail_SMS =  0.000000e+00

local beta_zero_Rail_SMS_Pool =  0.000000e+00
local beta_oneplus_Rail_SMS_Pool = -2.530000e+00
local beta_twoplus_Rail_SMS_Pool = -1.710000e+00
local beta_threeplus_Rail_SMS_Pool =  0.000000e+00

local beta_zero_motor =  0.000000e+00
local beta_oneplus_motor =  0.000000e+00
local beta_twoplus_motor =  4.790000e+00
local beta_threeplus_motor =  0.000000e+00

local beta_female_bus =  1.940000e+00
local beta_female_mrt =  1.600000e+00
local beta_female_private_bus =  1.410000e+00
local beta_female_drive1 =  0.000000e+00
local beta_female_share2 =  1.720000e+00
local beta_female_share3 =  4.290000e-01
local beta_female_motor = -2.360000e+00
local beta_female_taxi =  2.890000e+00
local beta_female_walk =  3.080000e+00
local beta_female_Rail_SMS =  1.600000e+00
local beta_female_SMS =  2.890000e+00
local beta_female_Rail_SMS_Pool =  1.600000e+00
local beta_female_SMS_Pool =  2.890000e+00
