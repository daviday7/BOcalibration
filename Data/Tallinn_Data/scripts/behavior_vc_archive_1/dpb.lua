...
--travel constants
local cons_travel =  2.827415e+00

--Person type
local beta_homemaker =  0.000000e+00
local beta_retired =  9.390135e-01
local beta_fulltime =  1.832718e+01
local beta_parttime =  0.000000e+00
local beta_selfemployed =  0.000000e+00
local beta_unemployed =  1.461336e+00

--female dummy
local beta_female_travel =  2.769776e+00


--Adult age group
local beta_age2025_travel = -4.037136e+00
local beta_age2635_travel = -3.013085e+00
local beta_age3650_travel = -1.186323e+00
local beta_age5165_travel =  2.779300e-01
local beta_age65_travel = -2.576109e+00



--Adult gender/children
local beta_maleage4_travel = -8.831127e-01
local beta_maleage515_travel = -1.371813e+01
local beta_femalenone_travel = -1.544719e+00
local beta_femaleage4_travel = -6.697915e+00
local beta_femaleage515_travel =  1.860320e+00

--Household composition
local beta_onlyadults_travel = -1.094447e+01


--Personal income
local beta_income_travel = -2.438363e-01
local beta_missingincome_travel =  6.608719e+00

--Others
local beta_workathome_travel =  0.000000e+00


local beta_twoplus_car_travel =  1.385288e+00
local beta_one_car_travel =  5.838521e-01

local beta_motoravail_travel =  2.299537e+00


--logsums
local beta_dptour_logsum =  1.686540e-01
